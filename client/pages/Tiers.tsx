    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 lg:ml-56 pt-16 lg:pt-0">
        ...
        <div className="px-4 pb-10 max-w-2xl mx-auto w-full">
          <div className="mb-4">
            <h2 className="text-xl font-bold">Preview Profiles Before You Upgrade</h2>
            <p className="text-sm text-muted-foreground mt-1">See exactly what each profile unlocks — dashboard, features, and tools.</p>
          </div>
          <RolePreview />
        </div>
      </main>
