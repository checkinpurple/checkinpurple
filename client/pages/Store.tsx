        ...
        <div className="px-4 py-6 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              {(["all", "merch", "digital", "ticket"] as Category[]).map(c => (
                <button key={c} onClick={() => setCategory(c)} className={`px-3 py-2 rounded-xl text-sm font-semibold transition-all border capitalize ${category === c ? "bg-primary text-primary-foreground border-transparent" : "border-border/40 text-muted-foreground hover:text-foreground"}`}>
                  {c === "all" ? "All" : c}
                </button>
              ))}
            </div>
