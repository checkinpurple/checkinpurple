...
const COIN_TO_ZAR = 0.07; // 1 coin = R0.07 (after 30% platform cut, artist gets 70% of R0.10)
const COIN_TO_USD = 0.004;
...
export default function Wallet() {
  ...
  const canWithdraw = wallet
    ? currency === "ZAR"
      ...
      : wallet.zarValue * (COIN_TO_USD / COIN_TO_ZAR) >= MIN_PAYOUT_USD
    : false;
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="glass rounded-2xl p-5">
              ...
              <p className="text-sm text-muted-foreground mt-1">≈ ${(((wallet?.zarValue || 0) * COIN_TO_USD) / COIN_TO_ZAR).toFixed(2)} USD</p>
            </div>
            ...
            <div className="glass rounded-2xl p-5">
              ...
              <p className="text-sm text-muted-foreground mt-1">coins all time</p>
            </div>
          </div>
                ...
                {wallet?.transactions.map(tx => (
                  <div key={tx.id} className="flex items-center justify-between p-3 rounded-xl bg-card/30 border border-border/20">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-muted-foreground">R{((tx.coins || 0) * COIN_TO_ZAR).toFixed(2)}</p>
                    </div>
                  </div>
                ))}
              </div>
