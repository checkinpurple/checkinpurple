  ...
  const getLivepeerStreamKey = async () => {
    try {
      const res = await fetch("/api/stream/livepeer-key", {
        ...
        body: JSON.stringify({ name: streamTitle || undefined }),
      });
        ...
        <div className="max-w-4xl mx-auto space-y-5">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button disabled={!isLive} onClick={shareLink} className="py-3 px-5 rounded-xl font-semibold border border-primary/30 bg-primary/5 hover:bg-primary/10 transition-colors flex items-center justify-center gap-2 disabled:opacity-50">
